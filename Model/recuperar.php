...
<div class="row rowboxLogin align-items-center justify-content-center">
    ...
    <div class="col-xl-9 col-lg-9 col-md-10 col-sm-10 col-11 pb-4 pr-2 pl-2 form">
      ...
      <div class="text-center kl m-0">
        <img src="../View/img/reset.png" class="icono">
      </div>  
      ...
      <form method="POST" action="../Controller/c_recuperar.php" class="m-2">
        <div class="form-group"> 
          ...
          <input type="text" class="form-control" id="email" name="email" required="required" autocomplete="on" placeholder="Ingresa Correo para Iniciar Sesion">
          <small class="form-text text-muted text-center"><a href="../View/registrarse.php">No tengo cuenta</a> - <a href="../View/index.php">Ya tengo cuenta</a></small>
        </div> 
